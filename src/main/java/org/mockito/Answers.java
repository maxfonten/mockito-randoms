...
import com.github.maxfonten.randomanswers.RandomAnswers;
...
public enum Answers {
    ...
    /**
     * An answer that returns random values or empty collections or deep stubs that do the same.
     *
     * @see RandomAnswers#RETURNS_RANDOMS
     */
    RETURNS_RANDOMS(RandomAnswers.RETURNS_RANDOMS)
    ;
